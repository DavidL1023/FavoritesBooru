...
USERNAME = constants["DANBOORU_USERNAME"]
USER_ID = constants["DANBOORU_USER_ID"]
API_KEY = constants["DANBOORU_API_KEY"]
API_GET_LIMIT = 200
API_STARTING_PAGE = 1
...
async def main():
    ...
    async with aiohttp.ClientSession() as session:
        ...
        output_data = {
            "images": danbooru_images,
            "tag_set": list(danbooru_tag_set)
        }
